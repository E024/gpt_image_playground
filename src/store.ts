  ...
  return value
    .map((item): BillingLedgerEntry | null => {
      ...
      return {
        ...
        units: normalizeNonNegativeInteger(item.units, 0),
        ...
        apiProvider: typeof item.apiProvider === 'string' ? item.apiProvider : '',
        apiMode: typeof item.apiMode === 'string' ? item.apiMode : '',
